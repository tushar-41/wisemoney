      ...
      <section className="mt-20 pb-12 space-y-12 md:space-y-20 px-5">
        <div className="container mx-auto px-4 md:px-6 text-center space-y-6">
          ...
          <p className="mx-auto max-w-[700px] text-gray-500 md:text/relaxed">
            Track shared Expenses, split bill effortlessly, and settle up
            quickly. Never who owes who again.
          </p>
        ...
        <div
          ...
          shadow-xl"
        >
          <div className="gradient p-[3px] rounded-lg">
            <Image
              src="/image.png"
              width={1280}
              height={1200}
              alt="Banner"
              className="rounded-lg mx-auto hover:scale-102 transition-all duration-300"
              priority
            />
          </div>
        </div>
      ...
      <section className="py-20 gradient">
        <div className="container mx-auto px-4 md:px-6 text-center space-y-6">
          ...
          <p className="mx-auto max-w-[600px] text-green-100 md:text-xl/relaxed">
            Join thousands of users who have made splitting expenses stress
            free.
          </p>
          <Button
            asChild
